...
CPPFLAGS += -I./Drivers/STM32F4xx_StdPeriph_Driver/inc

# A simply expanded variable is used here to perform the find command only once.
# STD_SRC := $(shell find ./Drivers/STM32F4xx_StdPeriph_Driver/src/*.c ! -name '*_template.c')
# SRC += $(STD_SRC)

SRC += ./Drivers/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_rcc.c \
